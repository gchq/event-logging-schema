...
#  ./create_mock_combined_site.sh && cd /tmp/event-logging-schema_mock_combined_site && python -m SimpleHTTPServer 8888
############################################################
...
main() {
  ...
  local TEMP_BUILD_DIR="/tmp/event-logging-schema_build_dir"
  local COMBINED_SITE_DIR="/tmp/event-logging-schema_mock_combined_site${BASE_URL}"
